        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-[#e5e4e0] font-montserrat font-thin">
            <p className="text-lg md:text-xl leading-relaxed">
              Explore nossa galeria de inspirações e projetos no Pinterest.
            </p>

            <div className="mt-12 p-8 border border-[#e5e4e0]/20 rounded-lg">
              <h3 className="text-2xl font-black-mango tracking-wider mb-6">INSPIRAÇÃO</h3>
              <p className="text-lg mb-6">Descubra tendências, cores e conceitos que inspiram nosso trabalho.</p>

              <a
                href="https://pinterest.com/authstudio"
                target="_blank"

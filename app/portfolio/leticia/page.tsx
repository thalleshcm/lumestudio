  ...
  return (
    <div className="bg-[#E7E6E2] min-h-screen text-[#222]">
      ...
      <section className="relative w-full h-[50vh] md:h-[95vh] flex items-center justify-center overflow-hidden bg-white">
        <img 
          src="/images/leticia/prancheta.jpg" 
          alt="Prancheta Letícia" 
      ...
      <section className="w-full h-auto min-h-[83vh] bg-[#E8E6E2] flex items-center justify-center py-12">
        <div className="max-w-7xl w-full px-4 md:px-8 grid grid-cols-1 md:grid-cols-4 gap-y-12 gap-x-20 text-black items-start ml-0 md:ml-8 lg:ml-12">
          <div className="md:col-span-2 text-center md:text-left">
            <h2 className="font-extrabold tracking-widest mb-3 text-3xl text-black">DRA. LETÍCIA PERON</h2>
            <p className="mb-6 text-xl text-black">Cirurgiã-Dentista | Estética Orofacial</p>
            <p className="mb-4 text-lg text-black text-justify">
              Letícia Peron é cirurgiã-dentista especializada em estética orofacial, com atuação focada no cuidado personalizado e resultados naturais.
            </p>
            <p className="mb-4 text-lg text-black text-justify">
              Sua prática é guiada pela sensibilidade estética, técnica precisa e um olhar atento à beleza individual de cada paciente.
            </p>
            <p className="mb-4 text-lg text-black text-justify">
              <span className="font-bold">Missão:</span> transformar a autoestima e valorizar a essência de cada pessoa, promovendo bem-estar
            </p>
          </div>
      ...
      <section className="relative w-full h-[50vh] md:h-[95vh] flex items-center justify-center overflow-hidden bg-white">
        <img 
          src="/images/leticia/sessionleticia_2.jpg" 
          alt="Sessão Letícia 1" 
          className="absolute inset-0 w-full h-full object-contain md:object-fill bg-white"
        />
      </section>
      {/* Sessão Letícia 2 */}
      <section className="relative w-full h-[50vh] md:h-[95vh] flex items-center justify-center overflow-hidden bg-white">
        <img 
          src="/images/leticia/sessionleticia_3.jpg" 
          alt="Sessão Letícia 2" 
          className="absolute inset-0 w-full h-full object-contain md:object-fill bg-white"
        />
      </section>
      {/* Sessão Letícia 3 */}
      <section className="relative w-full h-[50vh] md:h-[95vh] flex items-center justify-center overflow-hidden bg-white">
        <img 
          src="/images/leticia/sessionleticia.jpg" 
          alt="Sessão Letícia 3" 
          className="absolute inset-0 w-full h-full object-contain md:object-fill bg-white"
        />
      </section>

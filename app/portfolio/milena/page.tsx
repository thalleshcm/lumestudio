    ...
    <div className="bg-[#E7E6E2] min-h-screen text-[#222]">
      ...
      <div className="px-4 md:px-8 py-4">
        <nav className="text-sm text-[#666]">
          ...
          <span className="text-[#222]">Milena</span>
        </nav>
      </div>
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-12">
            <img src="/images/logomilena.png" alt="Logo Milena" className="h-32 md:h-48 w-auto mx-auto mb-8" />
            <h1 className="text-4xl md:text-6xl font-bold text-[#222] mb-6 font-montserrat tracking-wide">Milena</h1>
            <p className="text-xl md:text-2xl text-[#666] max-w-3xl mx-auto font-montserrat">
              Design de marca elegante e estratégia de posicionamento
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-[#666] leading-relaxed">
                Criação de uma identidade visual sofisticada que transmite 
                elegância e profissionalismo para o negócio da Milena.
              </p>
              <ul className="space-y-2 text-[#666]">
                <li>• Logo principal e variações</li>
                <li>• Paleta de cores sofisticada</li>
                <li>• Tipografia elegante</li>
                <li>• Diretrizes de marca</li>
              </ul>
            </div>
            
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-[#222] font-montserrat">Material Corporativo</h3>
              <p className="text-[#666] leading-relaxed">
                Desenvolvimento de materiais corporativos premium que 
                reforçam a imagem profissional e elegante da marca.
              </p>
              <ul className="space-y-2 text-[#666]">
                <li>• Cartões de visita premium</li>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-white rounded-lg shadow-sm">
              <h3 className="text-2xl font-bold text-[#222] mb-2">+180%</h3>
              <p className="text-[#666]">Aumento na percepção de qualidade</p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-sm">
              <h3 className="text-2xl font-bold text-[#222] mb-2">+90%</h3>
              <p className="text-[#666]">Melhoria no posicionamento</p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-sm">
